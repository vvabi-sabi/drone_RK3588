...
class RK3588():
    ...
    ---------------------------------------------------------------------------
    """
    def __init__(self, camera, models=['YOLO'], post_process=True, show_trajectory=False):
        ...
        self.neuro = NeuroModule(self._cores, ['Model_1', 'Model_2'])
        self.model = [AutoEncoder(proc=i,
