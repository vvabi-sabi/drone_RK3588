...
ONNX_MODEL = 'encoder/encoder.pt'
RKNN_MODEL = 'encoder/encoder_pt.rknn'


if __name__ == '__main__':

    input_size_list = [[1, 1, 160, 320]]
    # Create RKNN object
    ...
    # Load ONNX model
    print('--> Loading model')
    ret = rknn.load_pytorch(model=ONNX_MODEL, input_size_list=input_size_list)
    if ret != 0:
